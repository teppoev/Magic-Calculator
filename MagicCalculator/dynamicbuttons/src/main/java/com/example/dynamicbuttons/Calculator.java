...
public class Calculator implements ICalculator {
    ...
    public double Calculate(String string, Map<String, Variable> _variables, Map<String, Function> _functions)
        ...
        return calcPostfix(infixToPostfix(filter(string)));
    }

    public double Calculate(ArrayList<Token> tokens, Map<String, Variable> _variables, Map<String, Function> _functions)
            throws IOException, BraketsFunctionException, BraketsOpenException, BraketsCloseException, ExtraCommaException, IncorrectPostfixException {
        variables = _variables;
        functions = _functions;
